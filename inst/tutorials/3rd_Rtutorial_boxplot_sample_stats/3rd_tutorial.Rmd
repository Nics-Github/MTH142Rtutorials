---
title: "Tutorial 3: Summary Statistics"
...
editor_options: 
  markdown: 
    wrap: 72
description: "Summary Stats with favstats() and gf_boxplot()"
---
...
1.  read about the data set. ([see
    openintro.org](https://www.openintro.org/data/index.php?data=fastfood)) or ?fastfood
...
5.  Notice the `calories` are all over the place from 20 to 2430, this
    ...
    fries. We should edit the formula to group the food by
    restaurants.
...
Here is the
[outline](https://github.com/Nics-Github/MTH142Rtutorials/blob/master/inst/tutorials/3rd_Rtutorial_boxplot_sample_stats/3rd_Rtutorial_outline.txt).
