---
title: "Tutorial 9: Proportion Hypothesis Test"
author: "Nicholas Schwab"
output: learnr::tutorial
runtime: shiny_prerendered
description: "In this tutorial we'll set up and run a single proportion hypothesis test."
---
...
Here is the [video](https://youtu.be/gE7x1U6qvpA) of me walking through the 9th Rtutorial.
...
-   Post the pdf output of your Rmarkdown file to the forum. See the video and my output for the format.

### Assignment Outline

Here is the [outline](https://github.com/Nics-Github/MTH142Rtutorials/blob/master/inst/tutorials/9th_Rtutorial_1_Prop_test/9th_Rtutorial_outline.txt). Copy and paste it from here and paste it into a new .rmd file.
