---
title: "Tutorial 7: Confidence Interval with prop.test()"
author: "Nicholas Schwab"
output: learnr::tutorial
runtime: shiny_prerendered
description: "In this tutorial we'll calculate confidence intervals with the Binomial Distribution"
---
...
Here's [the video](https://hcc-edu.zoom.us/rec/share/a2tW0FA8wG1pd0YNtKPeKPIxFoZHaCOQHXGJ0BU-CY6VfyqHh53vm-uRZaF2j7VE.rS4erNbhAe81ttSb) of me doing this tutorial
...
### Verify Independence and Success Failure Criterion

First Verify Independence by reasoning through it (see video). Then check to be sure we have at least 10 successes and 10 failures. You can use the tally() function for that.

```{r couting-success,exercise=TRUE, exercise.eval=FALSE}
...
Here is the [outline](https://github.com/Nics-Github/MTH142Rtutorials/blob/master/inst/tutorials/7th_Rtutorial_Prop_CI/7th_Rtutorial_outline.txt). Copy and paste it from here and paste it into a new .rmd file.
