...
1.  Import data from a homework problem. I've done this in the background for this tutorial, if you need a refresher see Rtutorial 4 or ask for on in the Rtutorial help forum. This problem comes from HW 7 part 4. I've named the Data `Problem_1_data`. Here's the text from that problem from the OpenIntro Book.
