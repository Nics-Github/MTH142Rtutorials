---
title: "Tutorial 5: More graphing"
author: "by Nicholas Schwab"
output: learnr::tutorial
runtime: shiny_prerendered
description: "gf_histogram(), favstats(), and gf_boxplot() by variable levels"
---
...
[Here is the video of me walking through this tutorial](https://youtu.be/Q2BKziixGo8)

## Make a histogram

We made a histogram back in 2nd Rtutorial. Remember to use gf_histogram(), our variable must be numeric.

1.  For this document tutorial we'll use the `run17` dataframe from `openintro`. Read about it with `?run17` after you load the libraries in the chunk below.
...
quiz(
  ...
  question("The 10 mile race is much more popular than the 5k",
   ...
   question("The skew in 5 k race...",
    ...
    answer("means the mean is less than the median", correct= FALSE),
...
You are to create a pdf file from an Rmarkdown file.
...
-   Output your Rmarkdown file as an pdf document and post it to the forum.

### Assignment Outline

Here is the [outline](https://github.com/Nics-Github/MTH142Rtutorials/blob/master/inst/tutorials/5th_Rtutorial/5th_Rtutorial_outline.txt). Copy and paste it from here and paste it into a new .rmd file.
