...
```{r summary, exercise=TRUE, exercise.setup="prepare-scatter"}
msummary()
sqrt()
cor()
```
...
Here is the
[outline](https://github.com/Nics-Github/MTH142Rtutorials/blob/master/inst/tutorials/14th_Rtutorial_linear_regression/14th_Rtutorial_outline.txt).
