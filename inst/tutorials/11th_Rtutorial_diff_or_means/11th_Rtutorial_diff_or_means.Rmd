...
library(learnr)
library(readxl)
Problem_1_data <- read_excel("~/GitHub/MTH142Rtutorials/inst/tutorials/11th_Rtutorial_diff_or_means/Problem-1-data.xlsx")
library(mosaic)
library(openintro)
...
Here is the
[outline](https://github.com/Nics-Github/MTH142Rtutorials/blob/master/inst/tutorials/11th_Rtutorial_diff_or_means/11th_Rtutorial_outline.txt).
